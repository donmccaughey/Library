...
- [EPUB 2.0 specifications](https://idpf.org/epub/201)
    ...
    + [Open Packaging Format (OPF)](https://idpf.org/epub/20/spec/OPF_2.0.1_draft.htm)
    + [Open Publication Structure (OPS)](https://idpf.org/epub/20/spec/OPS_2.0.1_draft.htm)
- [Dublin Core](https://www.dublincore.org/specifications/dublin-core/)
    + [Metadata Terms](https://www.dublincore.org/specifications/dublin-core/dcmi-terms/)
